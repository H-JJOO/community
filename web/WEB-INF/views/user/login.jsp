...
<div class="flex-container flex-center flex-direction-column">
    ...
    <form action="/user/login" method="post" id="login-frm">
        <div class="id-input"><label>id : <input type="text" name="uid" value="${requestScope.tryLogin.uid}"></label></div>
        <div class="pw-input"><label>password : <input type="password" name="upw"></label></div>
        <div class="d-sub-btn">
            <input type="submit" value="LOGIN" class="sub-btn">
            <a href="/user/join"><input type="button" value="JOIN" class="sub-btn"></a>
        </div>
    </form>
</div>
<!--
